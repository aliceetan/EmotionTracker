...
import hu.ait.android.emotiontracker.actions.HappyActions;
...
public class FeelActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.how_do_you_feel, menu);
        return true;
    }
    ...
    private void setUpButtons(){
        ...
        btnOverwhelmed = findViewById(R.id.btnOverwhelmed);
        ...
        btnHappy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FeelActivity.this, HappyActions.class);
